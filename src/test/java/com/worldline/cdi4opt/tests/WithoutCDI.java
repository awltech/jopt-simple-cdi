...
public class WithoutCDI {
	...
	public void configureParser() {
		...
		optionParser.accepts("value1").withRequiredArg().ofType(String.class).describedAs("This is value1");
		optionParser.accepts("value2").withRequiredArg().ofType(String.class).describedAs("This is value2");
	}
